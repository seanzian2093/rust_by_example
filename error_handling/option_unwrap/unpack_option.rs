#![allow(dead_code)]
// can unpack Options by using match statements
// - but it's often easier to use the `?` operator. If x is an `Option`, then
...
// - we can chain many ?s together to make your code much more readable
// - e.g.
