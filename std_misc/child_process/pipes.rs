...
pub fn main() {
    ...
    // Bind a stdin and stdout to the child process
    ...
    // Write a string to the `stdin` of `wc`.
        ...
        // - but since we know this instance must have one, we can directly `unwrap` it.
            // - because we bound one to it earlier
